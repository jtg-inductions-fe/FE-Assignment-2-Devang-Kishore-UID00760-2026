...
export type { ProfileMenuProps } from '../components/profileMenu/profileMenu.types';
export type { HeaderProps } from '../components/header/header.types';
export type { RestaurantCardProps } from '../components/restaurantCard/restaurantCard.types';
